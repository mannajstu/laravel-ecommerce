...
//        return view('admin.product.editProduct', ['productById' => $productById, 'categories' => $categories, 'manufacturers' => $manufacturers]);
    ...
    public function updateProduct(Request $request) {
        ...
        $product->publicationStatus = $request->publicationStatus;
        $product->save();
        return redirect('/product/add')->with('message', 'Product info Update Sauccessfully');
    }
...
//            unlink();
     ...
     public function deleteProduct($id){
        ...
        $product->delete();
        return redirect('/product/add')->with('message','Product Information Delete Successfully');
    } 
